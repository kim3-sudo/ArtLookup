  ...
  if (artData.length < 1) {
    return "<h3>Internal Error</h3>";
      ...
      for (var i = 6; i < listLength; i+=13){
        ...
        //Creates image
        result += '<img class="img-fluid lazyload" src=' + artData[i] + ' height="100%" align="left" style = "padding-top: 10px; padding-right: 10px">';
        //Creates description
        ...
        result += '<form><div class="form-group"><input class="form-control commentClass" type="text" placeholder="comment here!"><button class="btn btn-light" type="button" style="margin-bottom: 70px;margin-top: 10px;">submit</button>';
        //Adds closing tags
