...
function showPhotos(list){
  ...
  if (artData.length < 1) {
    ...
    for (var i = 6; i < listLength; i+=13){
      ...
      // viewComments button
      result += '<button class="btn btn-primary hideComments" id = "' + artData[i-6] + 'HC" type="button" name = "' + artData[i-6] +'"style="margin-bottom: 10px;margin-top: 10px; display: none;">Hide Comments</button>';
